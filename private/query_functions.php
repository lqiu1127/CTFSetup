<?php
  ...
  function validate_user($user, $errors=array()) {
    ...
    if (!is_blank($user['password'])) {
      // to confirm that previous password is correct
      $prev_users_result = find_users_by_username($user['username']);
      // one result
      $prev_user = db_fetch_assoc($prev_users_result);
  ...
  function insert_user($user) {
    global $db;
    // if inserting new user, assume that the previous password
    // is same as the password just entered for validation 
